...
def RefreshTor():
    with Controller.from_port(port = 9051) as controller:
        controller.authenticate(password='XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX')
...
[ \x1b[1;38;5;120m+\x1b[0m ] b00fd : \x1b[1;38;5;255m{threadSend}\x1b[0m
""")
#-------------------------------------------------------------------------------------------#
